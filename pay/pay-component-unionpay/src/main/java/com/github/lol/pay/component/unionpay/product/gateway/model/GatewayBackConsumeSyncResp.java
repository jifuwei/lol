...
/**
 * back consume sync response data
 * referenced document:
...
@Data
@NoArgsConstructor
public class GatewayBackConsumeSyncResp implements Serializable {
    private static final long serialVersionUID = -3255908660339871841L;

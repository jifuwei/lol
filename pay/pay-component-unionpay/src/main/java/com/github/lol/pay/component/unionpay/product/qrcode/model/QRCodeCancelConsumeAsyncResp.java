...
/**
 * qr code cancel consume async response
 *
 * @author: jifuwei
...
@AllArgsConstructor
@Builder
public class QRCodeCancelConsumeAsyncResp implements Serializable {
    private static final long serialVersionUID = 1756363044701880589L;

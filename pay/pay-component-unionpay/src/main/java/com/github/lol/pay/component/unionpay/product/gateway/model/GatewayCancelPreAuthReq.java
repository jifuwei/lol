...
@AllArgsConstructor
@Builder
public class GatewayCancelPreAuthReq implements Serializable {
    ...
    public static GatewayCancelPreAuthReqBuilder of(UnionpayConfig config) {
        return GatewayCancelPreAuthReq.builder()
                /**
                 * 商户接入参数
                 */

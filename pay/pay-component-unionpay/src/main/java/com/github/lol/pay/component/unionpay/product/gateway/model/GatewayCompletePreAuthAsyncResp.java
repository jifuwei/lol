...
/**
 * complete pre auth async response data
 * referenced document:
...
@Data
@NoArgsConstructor
public class GatewayCompletePreAuthAsyncResp implements Serializable {
    private static final long serialVersionUID = -6357478642264986722L;

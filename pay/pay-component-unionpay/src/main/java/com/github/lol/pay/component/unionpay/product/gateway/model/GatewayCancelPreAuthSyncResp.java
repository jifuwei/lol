...
/**
 * cancel pre auth sync response data
 * referenced document:
...
@Data
@NoArgsConstructor
public class GatewayCancelPreAuthSyncResp implements Serializable {
    private static final long serialVersionUID = 6268044306889805750L;
